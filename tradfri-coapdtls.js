...
(function() {
  ...
  TradfriCoapdtls = (function(superClass) {
    ...
    TradfriCoapdtls.prototype.setReboot = function() {
      return this._send_request('/15011/9030', false, false, false, true);
    };

    TradfriCoapdtls.prototype.setDiscovery = function() {
      var payload;
      payload = {
        9061: 30
      };
    ...
    TradfriCoapdtls.prototype._send_request = function(command, payload, callback, ident, poster) {
      return throttler.enqueue((function(_this) {
        return function(bla) {
          return _this._send_command(command, payload, callback, ident, poster);
        };
      })(this), 'coap-req');
    };

    TradfriCoapdtls.prototype._send_command = function(command, payload, callback, ident, poster) {
      this.req = null;
      return new Promise((function(_this) {
        return function(resolve, reject) {
          var url;
